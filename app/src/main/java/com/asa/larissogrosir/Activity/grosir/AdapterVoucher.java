...
public class AdapterVoucher extends ArrayAdapter<String> {
    ...
    public AdapterVoucher(Activity context, ArrayList<String> kd_voucher, ArrayList<String> nama_voucher, ArrayList<String> nilai_voucher, ArrayList<String> sk, ArrayList<String> tgl_berlaku, OnEditLocationListener btn_gunakan) {
        super(context, R.layout.adapter_transaksi, kd_voucher);
