package com.asa.larissogrosir.Activity;
...
public class inputClassMinMax implements InputFilter, View.OnFocusChangeListener {

    private final int min, max;

    public inputClassMinMax(int min, int max) {
        if (min > max) {
